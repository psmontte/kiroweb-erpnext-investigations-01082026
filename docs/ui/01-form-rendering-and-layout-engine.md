...
|---|---|---|
| `Code` | `df.options` is looked up in a fourteen-entry map; an unrecognised value produces a `console.warn` and no mode change | `frappe/public/js/frappe/form/controls/code.js:198-227` |
