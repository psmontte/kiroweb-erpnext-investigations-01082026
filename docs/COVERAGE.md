...
|---|---:|---:|---:|---:|---:|
| Accounts | 92 | 46 | 6 | 26 | 14 |
| Stock | 45 | 26 | 0 | 12 | 7 |
| Selling | 12 | 4 | 2 | 3 | 3 |
| Buying | 10 | 1 | 2 | 2 | 5 |
| Subcontracting | 4 | 1 | 2 | 1 | 0 |
| **Total** | **163** | **78** | **12** | **44** | **29** |
<!-- END COVERAGE TABLE -->
...
4. `tools/verify_refs.py` reports **0 problems** across all doc directories — no unresolved paths,
   ...
   the "every claim is checkable" statement true. Current: **2812** citations in `docs/logic` and
...
| # | Criterion | State |
|---|---|---|
| 1 | `uncited_submittable` = 0 | Stock **0** ✔; Accounts 6, Selling 2, Buying 2 remaining (docs 29–31) |
| 2 | Config DocTypes cited or excluded | tax config **done** (doc 28); pricing + party config in docs 29–30 |
| 3 | Scenario per cross-subsystem flow | S01–S06 done |
| 4 | `verify_refs.py` 0 problems | **✔ 0 problems, 3271 citations** |
| 5 | Table regenerated | **✔** |
