...
|---|---:|---:|---:|---:|---:|
| Accounts | 92 | 54 | 6 | 18 | 14 |
| Stock | 45 | 28 | 0 | 10 | 7 |
| Selling | 12 | 8 | 0 | 1 | 3 |
| Buying | 10 | 5 | 0 | 0 | 5 |
| Subcontracting | 4 | 1 | 2 | 1 | 0 |
| **Total** | **163** | **96** | **8** | **30** | **29** |
<!-- END COVERAGE TABLE -->
...
4. `tools/verify_refs.py` reports **0 problems** across all doc directories — no unresolved paths,
   ...
   the "every claim is checkable" statement true. Current: **3035** citations in `docs/logic` and
...
| # | Criterion | State |
|---|---|---|
| 1 | `uncited_submittable` = 0 | Stock **0** ✔, Selling **0** ✔, Buying **0** ✔; Accounts 6 remaining (doc 31). Subcontracting 2 deferred to Tranche B |
| 2 | Config DocTypes cited or excluded | tax (doc 28), pricing (doc 29), party + terms + settings (doc 30) **done**; banking/recurring in doc 31 |
| 3 | Scenario per cross-subsystem flow | S01–S06 done |
| 4 | `verify_refs.py` 0 problems | **✔ 0 problems, 3494 citations** |
| 5 | Table regenerated | **✔** |
